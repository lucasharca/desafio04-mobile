...
export default function App() {
  ...
  async function handleLikeRepository(id) {
    ...
    const repoIndex = repositories.findIndex(repo => repo.id === repositorio.id)
    let updatedArray = [...repositories];
    updatedArray[repoIndex] = repositorio;
            ...
            renderItem={({ item: repositories }) => (
              <>
                ...
                <View style={styles.likesContainer}>
                  ...
                  >
                    {repositories.likes} {repositories.likes > 1 ? "curtidas" : "curtida"}
                  </Text>
                </View>
                <TouchableOpacity
                  style={styles.button}
